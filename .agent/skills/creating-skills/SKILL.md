...
description: Guides the agent in generating high-quality, predictable, and efficient .agent/skills/ directories based on user requirements. Use when the user asks to create a new skill or modify an existing skill.
---
