  ...
  <div className="max-w-7xl mx-auto">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
      ...
      <div>
        ...
        <ul className="space-y-4 text-sm">
          <li><a href="#" className="text-white hover:text-bb-gold transition-colors">BAC Portal</a></li>
          <li><a href="#" className="text-white hover:text-bb-gold transition-colors">Supplier Dashboard</a></li>
          <li><a href="#" className="text-white hover:text-bb-gold transition-colors">Transparency Portal</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-4 text-sm">
          <li><a href="#" className="text-white hover:text-bb-gold transition-colors">API Documentation</a></li>
          <li><a href="#" className="text-white hover:text-bb-gold transition-colors">Smart Contracts</a></li>
          <li><a href="#" className="text-white hover:text-bb-gold transition-colors">Polygon Explorer</a></li>
        </ul>
      </div>
    ...
    <div className="border-t border-slate-800/50 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
      ...
      <div className="flex gap-6 text-xs font-semibold tracking-wider">
        ...
        <a href="#" className="text-white hover:text-bb-gold transition-colors">SECURITY</a>
      </div>
    </div>
  </div>
</footer>
