    ...
    <div className="py-6 px-4 md:py-8 md:px-8 max-w-6xl mx-auto w-full flex flex-col h-[calc(100vh-100px)]">
      ...
      <div className="flex flex-col lg:flex-row gap-6 flex-1 min-h-0">
        ...
        <div className="w-full lg:w-80 flex-shrink-0 flex flex-col gap-6 overflow-hidden">
          ...
          <div className="bg-surface border border-border p-5 rounded-none shadow-sm relative overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
          ...
          <div className="bg-surface border border-primary/30 p-5 rounded-none shadow-sm relative overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] flex-1">
