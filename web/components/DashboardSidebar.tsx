            ...
            {activeMode === "agency" && (
              <div className="mb-8">
                <Link
                  ...
                  className="flex items-center justify-center gap-3 w-full px-4 py-4 font-heading font-bold uppercase tracking-widest transition-colors rounded-none shadow-md bg-primary text-secondary hover:bg-primary-hover shadow-primary/20"
                >
